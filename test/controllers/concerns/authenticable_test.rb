# Класс, имитирующий поведение необходимое для тестов:
# содержит атрибут request, в который записан объект Struct (который
# в данном случае имитирует поведение запроса rails, содержащего
# headers-атрибут, типа Hash)
